...
public class UpdateGameUserOnUserNameChanged {
  private static final Logger logger =
      LoggerFactory.getLogger(UpdateGameUserOnUserNameChanged.class);
  private final GameUserRepository gameUserRepository;

  public UpdateGameUserOnUserNameChanged(GameUserRepository gameUserRepository) {
    this.gameUserRepository = gameUserRepository;
    logger.info(
        "UpdateGameUserOnUserNameChanged initialized with repository: {}",
        gameUserRepository.getClass().getSimpleName());
  }
