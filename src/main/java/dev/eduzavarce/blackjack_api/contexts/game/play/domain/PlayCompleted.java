...
public class PlayCompleted extends DomainEvent {
  private final String eventName;
  private final PlayDto body;

  public PlayCompleted(String aggregateId, String eventName, PlayDto primitives) {
  ...
  public DomainEvent fromPrimitives(
    ...
    return new PlayCompleted(aggregateId, eventName, playDto);
  }
}
